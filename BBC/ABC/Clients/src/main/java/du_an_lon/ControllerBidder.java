    ...
    private Node createPage(int pageIndex) {
        ...
        for (int i = start; i < end; i++) {
            try {
                ...
                // Đã thêm "Clients/" vào đầu đường dẫn
                java.io.File file = new java.io.File("Clients/src/main/resources/du_an_lon/AssetCard.fxml");

                // (Ghi chú nhỏ: Nếu bạn lỡ tạo thư mục tên chính xác là "src.main" có dấu chấm,
                // hãy đổi thành: "Clients/src.main/resources/du_an_lon/AssetCard.fxml")

                if (!file.exists()) {
                    System.out.println("Vẫn sai đường dẫn. Thử in ra thư mục hiện tại để kiểm tra:");
